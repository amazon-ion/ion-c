...
iERR _ion_writer_binary_write_float(ION_WRITER *pwriter, double value)
{
    iENTER;
    int len;
...
iERR _ion_writer_binary_write_float_32(ION_WRITER *pwriter, float value)
{
    iENTER;
    int len;
    ...
    IONCHECK( _ion_writer_binary_start_value( pwriter, ION_BINARY_TYPE_DESC_LENGTH + len ));
    // Unfortunately float and float_32 share the same TID
