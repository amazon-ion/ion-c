...
iERR ion_binary_test() {
    ...
    run_unit_test(test_ion_binary_len_int_64);
...
iERR test_ion_binary_len_int_64() {
    ...
    ASSERT_EQUALS_INT(0, ion_binary_len_int_64(0LL), "Wrong int64 length");
    ASSERT_EQUALS_INT(1, ion_binary_len_int_64(1LL), "Wrong int64 length");
    ASSERT_EQUALS_INT(1, ion_binary_len_int_64(-1LL), "Wrong int64 length");
    ASSERT_EQUALS_INT(2, ion_binary_len_int_64(255LL), "Wrong int64 length");
    ASSERT_EQUALS_INT(2, ion_binary_len_int_64(-255LL), "Wrong int64 length");
    ASSERT_EQUALS_INT(2, ion_binary_len_int_64(256LL), "Wrong int64 length");
    ASSERT_EQUALS_INT(2, ion_binary_len_int_64(-256LL), "Wrong int64 length");
